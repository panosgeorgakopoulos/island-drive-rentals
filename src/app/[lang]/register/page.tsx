        ...
        <div className="bg-white py-8 px-4 shadow-sm border sm:rounded-2xl sm:px-10">
          <form action={registerAction} className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-1">
                <input required name="password" minLength={6} type="password" className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
              </div>
            </div>
