  ...
  return (
    <div className="bg-[var(--color-surface-alt)] min-h-screen pb-20">
      ...
      <div className="bg-gray-900 border-b relative">
        <div className="absolute inset-0 bg-cover bg-center opacity-40 mix-blend-overlay pointer-events-none" style={{backgroundImage: 'url("https://www.bernard-gallay.com/uploads/destinations/Greece/Ionian%20Islands/yacht_charter_destination_itinerary_greece_ionian_islands_footer.jpg")'}} />
        <div className="max-w-6xl mx-auto px-4 md:px-8 section-spacing relative z-10 text-white">
          ...
          <p className="text-base md:text-lg text-gray-300 mt-4 max-w-xl text-balance">{t('subtitle')}</p>
        </div>
      </div>

      <div className="max-w-6xl mx-auto px-4 md:px-8 mt-10 md:mt-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          {ISLANDS.map(loc => (
            <div key={loc.id} className="card-premium p-5 md:p-8 group">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-1">{tLoc(loc.id as any)}</h3>
